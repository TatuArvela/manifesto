...
- Tags can be added or removed from a note via the tag picker in the editor
- Tags are created inline when added to a note; no predefined tag list is required
- The sidebar shows a list of all tags for filtering
- Clicking a tag in the sidebar filters the view to notes with that tag
- Tags can be renamed or deleted from the sidebar
