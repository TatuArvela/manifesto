export const en = {
  ...
  "settings.autoNotes.empty.intro":
    "An automatic note is generated by a small JavaScript plugin that you write or paste in. The plugin runs in a sandbox in your browser every time Manifesto starts, and whatever it returns shows up here as a note.",
  ...
  "settings.autoNotes.empty.outro":
    "Automatic notes rewrite themselves on every run, so edits to them do not stick. Add a plugin above, or point Manifesto at a URL to keep one up to date.",
