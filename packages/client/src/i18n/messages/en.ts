export const en = {
  ...
  "settings.boardBackground.texture.confetti": "Confetti",
  ...
  "tokens.name": "Name",
  "tokens.namePlaceholder": "What will use it?",
  "tokens.nameRequired": "Give the token a name",
  "tokens.expires": "Expires",
  "tokens.days": "In {count} days",
  "tokens.never": "Never",
  "tokens.create": "Create token",
  "tokens.showOnce":
    "Copy this token now. It is not shown again; if it is lost, revoke it and make another.",
  "tokens.secret": "New token",
  ...
  "tokens.revokeBody":
    "Anything using {name} stops working at once. This cannot be undone.",
  ...
  "webhooks.showOnce":
    "Copy this signing secret now to check deliveries with. It is not shown again.",
  "webhooks.secret": "Signing secret",
  "webhooks.copy": "Copy secret",
  "webhooks.copied": "Secret copied",
  "webhooks.loading": "Loading webhooks...",
  "webhooks.none": "No webhooks yet",
  "webhooks.neverDelivered": "Nothing delivered yet",
  "webhooks.lastDelivered": "Last delivered {when} ({status})",
  "webhooks.lastFailed": "Last delivery failed {when}: {error}",
  "webhooks.off": "Off. Turn it on to deliver again.",
  "webhooks.active": "Deliver",
  "webhooks.test": "Send a test",
  "webhooks.testOk": "Test delivered ({status})",
  "webhooks.testFailed": "Test failed: {error}",
  "webhooks.remove": "Remove",
  "webhooks.removeTitle": "Remove this webhook?",
  "webhooks.removeBody": "Nothing more is sent to {url}.",
  ...
  "twoFactor.loading": "Loading...",
  "twoFactor.isOff": "Two-factor sign-in is off.",
  "twoFactor.isOn": "Two-factor sign-in is on. Recovery codes left: {count}.",
  ...
  "twoFactor.recoveryHint":
    "Keep these recovery codes somewhere safe. Each signs you in once if you lose your authenticator. They are not shown again.",
  "twoFactor.copy": "Copy",
  "twoFactor.copied": "Recovery codes copied",
  "twoFactor.saved": "I have saved them",
  "twoFactor.turnedOn": "Two-factor sign-in is on",
  "twoFactor.turnedOff": "Two-factor sign-in is off",
  "twoFactor.wrongPassword": "That password is not right",
  "twoFactor.wrongCode":
  ...
  "login.twoFactor.code": "Code",
  "login.twoFactor.submit": "Sign in",
  "login.twoFactorRequired": "Enter a code",
  "login.twoFactorInvalid": "That code is not right",
  "account.updateAvailable": "Version {version} is available",
  "overview.updateAvailable": "Version {version} is out.",
  "overview.updateNotes": "What changed",
  "admin.exportNotes": "Download notes",
  "admin.exportFailed": "The notes could not be downloaded",
  "admin.tab.overview": "Overview",
  "overview.loading": "Loading the overview...",
  "overview.failed": "The overview could not be loaded",
  "overview.version": "Version {version}",
  "overview.uptimeDays": "up {days} d {hours} h",
  "overview.uptimeHours": "up {hours} h {minutes} min",
  "overview.users": "Accounts",
  "overview.notes": "Notes",
  "overview.trashed": "In the trash",
  "overview.shares": "Shares",
  "overview.images": "Images",
  "overview.imageBytes": "Image storage",
  "overview.versions": "Versions",
  "overview.perUser": "By account",
  "overview.account": "Account",
  "overview.jobs": "Background jobs",
  "overview.job.trash": "Emptying the trash",
  "overview.job.sessions": "Expiring sessions",
  "overview.job.attachments": "Removing unused images",
  "overview.job.backup": "Backing up the database",
  "overview.job.update": "Checking for a newer release",
  "overview.jobRunning": "Running",
  "overview.jobOk": "OK",
  ...
  "audit.more": "Older",
  "audit.nobody": "Someone not signed in",
  "audit.deletedAccount": "a deleted account",
  "audit.from": "from {ip}",
  "audit.action.account.registered": "Account created by sign-up",
  "audit.action.account.exported": "Downloaded their notes",
  "audit.action.auth.signed_in": "Signed in",
  "audit.action.auth.sign_in_failed": "Sign-in failed",
  "audit.action.auth.signed_out": "Signed out",
  ...
  "audit.action.token.created": "API token created",
  ...
  "audit.action.admin.admin_granted": "Made an admin",
  "audit.action.admin.admin_revoked": "Admin taken away",
  "audit.action.admin.email_changed": "Email address changed by an admin",
  "audit.action.admin.password_reset": "Temporary password issued",
  "audit.action.admin.user_exported": "Account's notes downloaded by an admin",
  "shortcuts.title": "Keyboard shortcuts",
  "shortcuts.newNote": "New note",
  "shortcuts.search": "Search",
  "shortcuts.next": "Next note",
  "shortcuts.previous": "Previous note",
  "shortcuts.open": "Open the focused note",
  "shortcuts.archive": "Archive or unarchive the focused note",
  "shortcuts.trash": "Move the focused note to the trash",
  "shortcuts.help": "Show this list",
  "shortcuts.note":
    "Shortcuts work on the board, not while typing or with a dialog open.",
