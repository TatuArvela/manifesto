...
export const fi: Messages = {
  ...
  "settings.noteCorners": "Kulmat",
  "settings.noteCorners.straight": "Suorat",
  "settings.noteCorners.rounded": "Pyöristetyt",
  "settings.animations": "Animaatiot",
  "settings.animations.on": "Käytössä",
  "settings.animations.off": "Pois käytöstä",
